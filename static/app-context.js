...
(function (global) {
  ...
  function createDomRegistry() {
    ...
    return {
      ...
      searchScopeSelect: getEl('searchScopeSelect'),
      ...
      scannedModelsCount: getEl('scannedModelsCount'),
      ...
      accountExportBtn: getEl('accountExportBtn'),
      accountRestoreBtn: getEl('accountRestoreBtn'),
      accountRestoreFile: getEl('accountRestoreFile'),
      diagnosticsBtn: getEl('diagnosticsBtn'),
      diagnosticsPanel: getEl('diagnosticsPanel'),
      diagnosticsRefreshBtn: getEl('diagnosticsRefreshBtn'),
      diagnosticsCopyBtn: getEl('diagnosticsCopyBtn'),
      diagnosticsOutput: getEl('diagnosticsOutput'),
      jobsRefreshBtn: getEl('jobsRefreshBtn'),
      jobsDeepStartBtn: getEl('jobsDeepStartBtn'),
      jobsDeepStopBtn: getEl('jobsDeepStopBtn'),
      jobsOverallStatus: getEl('jobsOverallStatus'),
      jobSyncStatus: getEl('jobSyncStatus'),
      jobQuickStatus: getEl('jobQuickStatus'),
      jobDeepStatus: getEl('jobDeepStatus'),
      jobDeepProgress: getEl('jobDeepProgress'),
